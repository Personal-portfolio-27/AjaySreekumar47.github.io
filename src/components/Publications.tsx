...
const PublicationCard = ({ publication }: { publication: Publication }) => (
  <Card className="border-data-blue/10 shadow-sm hover:shadow-md transition-all duration-300 animate-fade-in dark:border-data-blue/20 dark:bg-card">
    <CardHeader className="pb-2 pt-4 px-4 bg-data-light/50 border-b border-data-blue/10 dark:bg-secondary/50 dark:border-data-blue/20">
    ...
    <CardContent className="p-4 dark:bg-card">
      ...
      <div className="mt-3">
        <h4 className="text-xs font-semibold mb-1 text-gray-600 dark:text-gray-200">Abstract:</h4>
      ...
      <div className="mt-3">
        ...
        <div className="flex flex-wrap gap-1">
          {publication.keywords.map((keyword, index) => (
            <span 
              key={index} 
              className="text-xs px-1.5 py-0.5 bg-white rounded-full border border-data-blue/20 shadow-sm text-black dark:bg-secondary dark:text-white dark:border-data-blue/30"
            >
              {keyword}
            </span>
          ))}
